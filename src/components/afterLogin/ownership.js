...
class OwnersipData extends Component {
    constructor() {
        super()
        this.state = {
            data: null,
    ...
    render() {
        ...
        return (
            <>
                <Header open={this.state.open} login="true"  seemore={false} ownership={true} gettingValues={this.gettingValues} filter={this.filter} />
...
export default connect(mapStateToProps, matchDispatchToProps)(withStyles(styles)(withRouter(OwnersipData)));
