...
class RentData extends Component {
    constructor() {
        super()
        this.state = {
            data: null,
    ...
    render() {
        ...
        return (
            <>
                <Header open={this.state.open} seemore={false} login="true" rent={true} gettingValues={this.gettingValues} filter={this.filter} />
...
export default connect(mapStateToProps, matchDispatchToProps)(withStyles(styles)(withRouter(RentData)));
